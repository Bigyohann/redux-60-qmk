...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    GAMING_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,                          MO(_LOWER), MO(_RAISE), KC_APP,  KC_RCTL
    ),

    /* _CODE Layer: Code layer
    * ,---------------------------------------------------------------------------------.
    * | Esc |  1  |  2  |  3  |  4  |  5  |  6  |  7  |  8  |  9  |  0  |  -  |  =  |BSPC|
    * |---------------------------------------------------------------------------------|
    * | Tab    |  Q  |  W  |  E  |  R  |  T  |  Y  |  U  |  I  |  O  |  P  |  [  |  ]  |  \  |
    * |---------------------------------------------------------------------------------|
    * | RAISE/Esc   |  A  |  S  |  D  |  F  |  G  |  H  |  J  |  K  |  L  |  ;  |  '  | Enter   |
    * |---------------------------------------------------------------------------------|
    * | Shift     |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /  | Shift     |
    * |---------------------------------------------------------------------------------|
    * | LCTL | Win | Alt |          Space          | Raise | Win | Fn  | Ctl |
    ...
    */
    ...
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
    LT(_RAISE, KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,                          MO(_LOWER), MO(_RAISE), KC_APP,  KC_RCTL
    ),
    ...
    */
    [_RAISE] = LAYOUT(
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_GAMING,
    _______, KC_MS_WH_UP, KC_MS_UP, KC_MS_WH_DOWN, KC_RPRN, KC_NO,   KC_NO,   KC_PGUP, KC_UP,   KC_PGDN, KC_NO,   KC_NO,   KC_NO,   _______,
    _______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_RCBR, KC_NO,   KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO,   KC_NO,            _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (gaming_mode == true) {
        // Disable all layers except _BASE when gaming mode is active
        switch (keycode) {
            case KC_TAB:
            ...
            case KC_LGUI:
                ...
                break;
            case GAMING_CAPS:
                // simulate control when gaming mode is active
    ...
    switch (keycode) {
        ...
        case QK_BOOTLOADER:
            ...
            break;
        case GAMING_CAPS:
            if (gaming_mode == false) {
                // LT to _RAISE layer when gaming mode is inactive and Caps Lock is pressed
                if (record->event.pressed) {
                    layer_on(_RAISE);
                } else {
                    layer_off(_RAISE);
